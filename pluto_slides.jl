...
begin
	...
	using Symbolics
	    ...
	    using Einsum
	    using Tullio
	    using MLUtils, Images
	    using PlutoLinks, PlutoHooks
	using TikzPictures, LaTeXStrings, HypertextLiteral
end

# ╔═╡ ad60b91c-9b8f-4819-b119-ddbb54ec6784
ChooseDisplayMode()
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "96c07767228e3e6371ed2b84299f1c9a8c295e1b"
